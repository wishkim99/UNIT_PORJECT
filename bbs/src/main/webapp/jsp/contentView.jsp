...
<body>
   ...
   <form method="post" action="/bbs/board">
	<input type="hidden" name="id" value="${updatevo.id}">
      <table width="700" border="3" bordercolor="lightgray" align="center">
       <%
   WritingVO vo1 = (WritingVO) request.getAttribute("updatevo");
   ...
   %>
         ...
         <tr>
            <td id="title">제 목</td>
            <td><input type="text" size="70" maxlength="100"
         ...
         <input type="submit" value="수정확인dd">
   ...
   <form method="post" action="/bbs/board">
      ...
      <table width="700" border="3" bordercolor="lightgray" align="center">
         ...
         <tr>
            <td id="title">내 용</td>
            <td height="200"><table cols="72" rows="20">
                  <%=vo.getContent()%></table></td>
         </tr>
      </table>
